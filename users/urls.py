...
from users.views import user_logout_view, user_change_password_view, user_generate_new_password, \
    UserRegisterView, UserLoginView, UserProfileView, UserUpdateView
